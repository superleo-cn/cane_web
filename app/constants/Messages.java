...
public class Messages {
	...
	// Food Message
	public static String HEALTH_DATA_LIST_ERROR = "[Fetch health data List Error]";
	public static String HEALTH_DATA_LIST_ERROR_MESSAGE = "[System]-[Error]-[Crane({}) requests health data list failed. The error is {}.]";
